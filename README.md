<p align="center">
  <img src="docs/assets/ember-cutwave-256.png" width="104" height="104" alt="ScriptSurgeon Ember Cutwave icon">
</p>
...
<p align="center">
  ...
  &nbsp;·&nbsp;
  <a href="https://artmoreno.github.io/ScriptSurgeon/"><strong>ScriptSurgeon website</strong></a>
  &nbsp;·&nbsp;
  <a href="https://github.com/ArtMoreno/ScriptSurgeon/issues"><strong>Buy me a coffee</strong></a>
</p>
...
<p align="center">
  <a href="https://artmoreno.github.io/ScriptSurgeon/">
    <img src="docs/assets/ss-editor.webp" width="1100" alt="The ScriptSurgeon editor: an editable transcript with pause markers above a waveform timeline">
  </a>
</p>
...
- **Everything is free.** The Pro tier is gone. MP3 export, noise cleanup, loudness
  normalize, chapter exports, and timeline handoff now ship in every build, on both
  Windows and macOS.
- **Finish somewhere else.** Export the cut as an EDL or Final Cut XML and carry the
  edit into another editor without rendering.
- **A recorder you can set up before you speak.** Pick your input, check the level
  before the take, and choose raw capture or the browser's cleanup. Your choice is
  remembered.
- **Review before anything changes.** Filler, gap, and retake suggestions are all
  previewed, explained, and reversible, with persistent Keep choices.
- **Pacing you control.** Presets plus exact millisecond detection and target gaps.
- **Markers and chapters**, with chapter audio, chapter lists, and delivery text.

Read the [latest release notes and downloads](https://github.com/ArtMoreno/ScriptSurgeon/releases/latest).
...
<p align="center">
  <img src="docs/assets/ss-retakes.webp" width="980" alt="The cleanup workbench reviewing retakes, with two candidate takes and a recommendation">
</p>
...
<p align="center">
  <img src="docs/assets/ss-recorder.webp" width="980" alt="The insert recorder with microphone selection, an input-processing choice, and a level check">
</p>
...
ScriptSurgeon is free and always will be. If it saved you an afternoon and you
want to say thanks, [buy me a coffee](https://github.com/ArtMoreno/ScriptSurgeon/issues) - and a
star on the repository helps other people find it. More of my work lives at
[ScriptSurgeon website](https://artmoreno.github.io/ScriptSurgeon/).

ScriptSurgeon is available under the [MIT License](LICENSE). Use it, fork it,
ship it inside something else; the license asks only that the notice travels
with it.
